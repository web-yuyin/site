        ...
        cityList: function (options) {
            ...
            $(dataObj).each(function () {
                ...
                if (address[0] == this.name) {
                    $("#" + cp).append("<option value=" + this.value + "  selected='selected'>" + this.name + "</option>");
                } else {
                    $("#" + cp).append("<option value=" + this.value + ">" + this.name + "</option>");
                }
                    ...
                    if (dataObj[i]['name'] == obj) {
                        for (j = 0; j < dataObj[i]['cities'].length; j++) {
                            if (dataObj[i]['cities'][j]['name'] == address) {
                                $("#" + cc).append("<option value=" + dataObj[i]['cities'][j]['value'] + "   selected='selected'>" + dataObj[i]['cities'][j]['name'] + "</option>");
                            } else {
                                $("#" + cc).append("<option value=" + dataObj[i]['cities'][j]['value'] + ">" + dataObj[i]['cities'][j]['name'] + "</option>");
                            }
                        ...
                        if (dataObj[i]['cities'][j]['name'] == obj) {
                            for (m = 0; m < dataObj[i]['cities'][j]['quxian'].length; m++) {
                                if (dataObj[i]['cities'][j]['quxian'][m]['name'] == address) {
                                    $("#" + cd).append("<option value=" + dataObj[i]['cities'][j]['quxian'][m]['value'] + " selected='selected'>" + dataObj[i]['cities'][j]['quxian'][m]['name'] + "</option>");
                                } else {
                                    $("#" + cd).append("<option value=" + dataObj[i]['cities'][j]['quxian'][m]['value'] + ">" + dataObj[i]['cities'][j]['quxian'][m]['name'] + "</option>");
                                }
                            }
                        }
                    }
